          ...
          <div id="sidebar-menu" className="sidebar-menu">
            <ul>
              ...
              <li className="submenu">
                <a href="#"><i className="la la-cube"/> <span> Configurations</span> <span className="menu-arrow" /></a>
                <ul style={{display: 'none'}}>
                  <li><Link onClick={()=>localStorage.setItem("minheight","true")} to="/app/performanceManagement/config/setupAppraisal">Setup Appraisal</Link></li>
                  ...
                  <li><Link onClick={()=>localStorage.setItem("minheight","true")} to="/app/performanceManagement/config/teamGoal">Team Goal</Link></li>
                  <li><Link onClick={()=>localStorage.setItem("minheight","true")} to="/app/performanceManagement/config/unitKpi">Unit KPI</Link></li>
                  <li><Link onClick={()=>localStorage.setItem("minheight","true")} to="/app/performanceManagement/config/individualKpi">Individual KPI</Link></li>
                </ul>
              </li>
              ...
              <li className={pathname.includes('clients') ?"active" :""}> 
                <Link to = "/app/performanceManagement/supervisorAppraisal"><i className="la la-comment"/> <span>Supervisor Appraisal</span></Link>
              </li>

              <li className={pathname.includes('clients') ?"active" :""}> 
                <Link to = "/app/performanceManagement/allStaffAppraisals"><i className="la la-comment"/> <span>My Staff Appraisals</span></Link>
              </li>
