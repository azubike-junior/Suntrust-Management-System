                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <ul className="breadcrumb">
                      <li className="breadcrumb-item"><Link to = "/app/employees/expenses">Back to Expenses</Link></li>
                            ...
                            <div className="col-md-7">
                              <ul className="personal-info">
                                ...
                                <li>
                                  ...
                                  <span className="text">01234567890</span>
                                </li>
                                <li>
                                  <span className="title">TIN NO:</span>
                                  <span className="text">575436020</span>
                                </li>
                                <li>
                                  <span className="title">Date Registered:</span>
                                  <span className="text">27/08/2028</span>
                                </li>
                                <li>
                                  <span className="title">Registered by:</span>
                                  <span className="text">James McAvoy</span>
                                </li>
                                <li>
                                  <span className="title">Approved by:</span>
                                  <span className="text">Ferdinand Johnson</span>
                                </li>
                              </ul>
                            </div>
                          </div>
