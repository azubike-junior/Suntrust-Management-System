...
const Departments = () => {
    ...
    const [data, setData] = useState([
        {
            id: 1, bra_name: "Lagos Office", dept_name: "Information Technology", dept_code: "DEP-0021"
        }
    ]);
    useEffect(() => {
        if ($('.select').length > 0) {
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        ...
                        <div className="col-auto float-right ml-auto">
                            <a href="#" className="btn add-btn" data-toggle="modal" data-target="#add_client"><i className="fa fa-plus" /> Add New Department</a>
                        </div>
                    </div>
                </div>
                {/* /Page Header */}
                ...
                <div className="row filter-row">
                    <div className="col-sm-10 col-md-10">
                        <div className="form-group form-focus">
                            ...
                            <label className="focus-label">Search for a Department (e.g. Department Name)</label>
                        </div>
                    </div>
                        ...
                        <div className="modal-body">
                            <form>
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <div className="col-lg-4">
                                        <label className="col-form-label">Department Code<span className="text-danger">*</span></label>
                                        <input className="form-control" type="text" />
                                    </div>
                                </div>
