...
import { getVendors } from './../../services/configurations/vendors/getVendors.js';
  ...
  return (
    <div className="page-wrapper">
      ...
      <div className="content container-fluid">
        ...
        {/* Search Filter */}
        <div className="row">
          <div className="col-md-6 col-sm-12 col-12 col-lg-3 col-xl-3">
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <label className="col-form-label">
                        RC NO <span className="text-danger">*</span>
                      </label>
                      <input className="form-control floating" type="text" />
                    </div>
                  </div>
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <label className="col-form-label">
                        TIN NO <span className="text-danger">*</span>
                      </label>
                      <input
                        className="form-control floating"
