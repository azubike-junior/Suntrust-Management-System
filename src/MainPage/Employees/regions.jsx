...
const Regions = () => {
    ...
    const [data, setData] = useState([
        {
            id: 1, reg_name: "Region 1", reg_code: "REG-0021"
        }
    ]);
    useEffect(() => {
        if ($('.select').length > 0) {
    ...
    return (
        <div className="page-wrapper">
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        ...
                        <div className="col-auto float-right ml-auto">
                            <a href="#" className="btn add-btn" data-toggle="modal" data-target="#add_client"><i className="fa fa-plus" /> Add New Region</a>
                        </div>
                    </div>
                </div>
                {/* /Page Header */}
                ...
                <div className="row filter-row">
                    <div className="col-sm-10 col-md-10">
                        <div className="form-group form-focus">
                            ...
                            <label className="focus-label">Search for a Region (e.g. Region Name)</label>
                        </div>
                    </div>
            ...
            <div id="add_client" className="modal custom-modal fade" role="dialog">
                <div className="modal-dialog modal-dialog-centered modal-lg" role="Region">
                            ...
                            <form>
                                <div class="d-flex align-items-center justify-content-center">
                                    <div className="col-lg-6">
                                        <label className="col-form-label">Region Name<span className="text-danger">*</span></label>
                                    ...
                                    <div className="col-lg-6">
                                        <label className="col-form-label">Region Code<span className="text-danger">*</span></label>
