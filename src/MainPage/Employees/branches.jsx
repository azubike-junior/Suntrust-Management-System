...
const Branches = () => {
    ...
    const [data, setData] = useState([
        {
            id: 1, reg_name: "Region 1", bra_name: "Lagos Office", bra_code: "BRA-0021"
        }
    ]);
    useEffect(() => {
        if ($('.select').length > 0) {
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        ...
                        <div className="col-auto float-right ml-auto">
                            <a href="#" className="btn add-btn" data-toggle="modal" data-target="#add_client"><i className="fa fa-plus" /> Add New Branch</a>
                        </div>
                    </div>
                </div>
                {/* /Page Header */}
                ...
                <div className="row filter-row">
                    <div className="col-sm-10 col-md-10">
                        <div className="form-group form-focus">
                            ...
                            <label className="focus-label">Search for a Branch (e.g. Branch Name)</label>
                        </div>
                    </div>
