...
const MyStaffAppraisals = () => {
    ...
    const [data, setData] = useState([
        {
            id: 1, staff_id: "ST-0019", staff_name: "James McAvoy", tot_app_result: "87%",
        }
    ]);
    ...
    const columns = [
        ...
        },
        {
            title: '',
            render: (text, record) => (
                <Link to="/app/employees/staff_Appraisal_detail" className='btn btn-sm btn-outline-primary m-r-10'>
