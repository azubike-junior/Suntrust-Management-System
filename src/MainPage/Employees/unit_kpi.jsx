...
const Unit_KPI = () => {
    const [organizational_data, setOrganizationalData] = useState([
        // Process Category begins here
        {
            ...
            unit_kpi: "Self-help reports built for internal customers within a period",
            measure_target: "40",
            rate_type: "%",
        ...
        {
            id: 4, category_name: "Process",
            organ_goal: "Codified and Automated Processes and Manuals",
            dept_goal: "Ensure optimal performance on all core deliverables",
            unit_kpi: "Maintain 95% success rate for changes in line with IT Governance  and quarterly capacity report of DB/CBA",
            measure_target: "95",
            rate_type: "%",
            weight_percentage: "5",
        },
        {
            id: 5, category_name: "Process",
            organ_goal: "Codified and Automated Processes and Manuals",
            dept_goal: "Ensure optimal performance on all core deliverables",
            unit_kpi: "Ensure database performance tuning / CBA ugrade is done quarterly for improved performance across the Bank's CBA and all databases",
            measure_target: "100",
            rate_type: "%",
            weight_percentage: "10",
        },
        {
            id: 6, category_name: "Process",
            organ_goal: "Codified and Automated Processes and Manuals",
            dept_goal: "Ensure optimal performance on all core deliverables",
            unit_kpi: "Generation of RCA within 24 hours of incident occurrence  for which root cause was determined.",
            measure_target: "24",
            rate_type: "hrs",
            weight_percentage: "5",
        },
        {
            id: 7, category_name: "Process",
            organ_goal: "Codified and Automated Processes and Manuals",
            dept_goal: "Ensure optimal performance on all core deliverables",
        ...
        {
            id: 8, category_name: "Process",
            organ_goal: "Zero Governace Breaches, Regulatory Penalties and Fines",
            dept_goal: "Ensure total compliance with regulations and internal policies",
        ...
        {
            id: 9, category_name: "Customer",
            organ_goal: "External Net Promoter Score (Customer Experience) > 70%",
            dept_goal: "Maintain excellent service delivery to internal customers (regulatory enquiries, error free offer letters, credit checks, etc)",
        ...
        {
            id: 12, category_name: "Financial",
            organ_goal: "Profitability of N1 Billion",
            dept_goal: "Minimize operational losses due to data privacy and database security breaches",
        ...
        {
            id: 16, category_name: "Capacity Development",
            organ_goal: "Human Capacity Development Index  > 70%",
            dept_goal: "Pursue self-development as well as training hours on SunTrust Academy",
        ...
        {
            id: 17, category_name: "Capacity Development",
            organ_goal: "Human Capacity Development Index  > 70%",
            dept_goal: "Pursue self-development as well as training hours on SunTrust Academy",
    ...
    const organizational_columns = [
        ...
        },
        {
            title: '',
            render: (text, record) => (
                <Link to="#" data-toggle="modal" data-target="#delete_category" className='btn btn-sm btn-outline-danger m-r-10'>
                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 m-b-10">
                                ...
                                <div className="form-group">
                                    <select className="select">
                                        <option>Codified and Automated Processes and Manuals</option>
                                        <option>Zero Governance Breaches, Regulatory Penalties and Fines</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-6 m-b-10">
                                ...
                                <div className="form-group">
                                    <select className="select">
                                        <option>Ensure optimal performance on all core deliverables</option>
                                        <option>Ensure total compliance with regulations and internal policies</option>
                                    </select>
                                </div>
                            </div>
