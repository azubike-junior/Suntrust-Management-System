...
const ApproversPageInit = () => {

    const [data, setData] = useState([
        {
            id: 1, req_id: "0019", req_date: "23/02/2022", desc_txt: "Travelling", amount_req: "25,000"
        }
    ]);
    ...
    const columns = [
        ...
        },
        {
            title: '',
            render: (text, record) => (
                <Link to="#" data-toggle="modal" data-target="#view_details_modal" className='btn btn-sm btn-outline-primary m-r-10'><i className="fa fa-eye m-r-5" />View Info</Link>
            ),
        },
        // {
        //     title: 'Completion Status',
        //     render: (text, record) => (
        //         <Link to="/app/employees/approved_init_expense_requests" className='btn btn-sm btn-outline-success m-r-10'><i className="fa fa-credit-card m-r-5" />Complete Order</Link>
        //     ),
        // },
    ...
    return (
        <div className="page-wrapper">
            ...
            <div className="content container-fluid">
                ...
                <h3 className="page-title">Pending Payments</h3>
                ...
                <div className="row filter-row">
                    <div className="col-lg-10 col-sm-10 col-md-10">
                        <div className="form-group form-focus">
                            ...
                            <label className="focus-label">Search for a Request ID (e.g. REQ-0019)</label>
                        </div>
                    </div>
            ...
            <div className="modal fade" id="view_details_modal" tabindex="-1" role="dialog"
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="align-items-center justify-content-center">
                                <div className="col-md-12 font-weight-700">
                                    ...
                                    <div className="form-group m-b-30">
                                        <label className="text-center">UPLOAD JOB ORDER DOCUMENT <span className="text-danger">*</span></label><br />
                                        <input type="file" name="file-1[]" id="file-1" className="custom-input-file" data-multiple-caption="{count} files selected" multiple />
                                    </div>
                        ...
                        <div className="modal-footer justify-content-center align-items-center">
                            <div className="m-b-10">
                                <button className="btn btn-sm btn-primary submit-btn m-r-10" data-dismiss="modal">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default ApproversPageInit;
