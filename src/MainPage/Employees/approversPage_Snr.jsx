...
const ApproversPage = () => {
    ...
    const columns = [
        ...
        },
        {
            title: '',
            render: (text, record) => (
                <Link to="/app/employees/approved_expense_requests" className='btn btn-sm btn-outline-primary m-r-10'><i className="fa fa-eye m-r-5" />View Details</Link>
            ),
        },
    ...
    return (
        <div className="page-wrapper">
            ...
            <div className="content container-fluid">
                ...
                <h3 className="page-title">Approved Requests</h3>
