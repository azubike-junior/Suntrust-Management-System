...
const ApprovedExpenseRequest = () => {
    ...
    return (
        <div className="page-wrapper">
                        ...
                        <div className="col-sm-12">
                            ...
                            <ul className="breadcrumb">
                                <li className="breadcrumb-item">
                                    <Link to="/app/employees/approversPage_Snr">Back to Expense Requests</Link>
                                </li>
                                ...
                                <div className="profile-view">
                                    <div className="row">
                                        <div className="col-md-12 m-b-30">
                                            ...
                                            <div className="d-flex m-b-10">
                                                <div className="m-r-30 col-md-3" style={{ textAlign: 'left', verticalAlign: 'middle' }}>Payment Terms:</div>
            ...
            <div className="modal fade" id="view_reason_modal" tabindex="-1" role="dialog"
                aria-labelledby="view_feedback_modal" aria-hidden="true">
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header bg-dark align-items-center justify-content-center">
                            <h5 className="modal-title text-white font-weight-700 m-b-20" id="modal_title_6">REQUEST ID - ER4367</h5>
                        </div>
                        <div className="modal-body">
                            <div className="align-items-center justify-content-center">
                                <div className="d-flex m-b-10 margin_bottom font_size">
                                    <label className="col-lg-4 col-md-6 col-sm-12 font-weight-700">VENDOR ID:</label>
                                    <div className="col-lg-8 col-md-6 col-sm-12">0019</div>
                                </div>

                                <div className="d-flex m-b-10 margin_bottom font_size">
                                    <label className="col-lg-4 col-md-6 col-sm-12 font-weight-700">DOCUMENT TYPE:</label>
                                    <div className="col-lg-8 col-md-6 col-sm-12">Travelling Invoice</div>
                                </div>
                                <div className="d-flex m-t-20 m-b-10 margin_bottom font_size">
                                    <label className="col-lg-4 col-md-6 col-sm-12 font-weight-700">AMOUNT REQUESTED:</label>
                                    <div className="col-lg-8 col-md-6 col-sm-12">N25,000.90</div>
                                </div>

                                <div className="d-flex m-b-10 margin_bottom font_size">
                                    <label className="col-lg-4 col-md-6 col-sm-12 font-weight-700">RECOMMENDATION:</label>
                                    <div className="col-lg-8 col-md-6 col-sm-12">Recommended</div>
                                </div>

                                <div className="d-flex m-b-10 margin_bottom font_size">
                                    <label className="col-lg-4 col-md-6 col-sm-12 font-weight-700">REASON:</label>
                                    <div className="col-lg-8 col-md-6 col-sm-12">
                                    Lorizzle ipsizzle yo mamma sit i saw beyonces tizzles and my pizzle went crizzle, bow wow wow adipiscing da bomb. Nullam sapien velizzle, bling bling volutpizzle, suscipizzle quis, gravida vizzle, its fo rizzle. Things eget tortizzle. Fo shizzle erizzle. Own yo' tellivizzle dope dapibizzle mah nizzle tempizzle da bomb. Maurizzle pellentesque nibh et turpizzle. stuff tortizzle. shizzlin dizzle rhoncus mofo. Shut the shizzle up fizzle habitasse fo shizzle dictumst. Shizzle my nizzle crocodizzle dapibizzle. 
                                        </div>
                                </div>
                        ...
                        <div className="modal-footer justify-content-center align-items-center">
                            <a href="#" className="btn btn-block btn-primary font-weight-700 col-sm-4" data-dismiss="modal">CLOSE</a>
                        </div>
                    </div>
                </div>
            </div>
...
export default ApprovedExpenseRequest;
