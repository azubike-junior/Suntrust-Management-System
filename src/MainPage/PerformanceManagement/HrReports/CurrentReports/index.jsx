  ...
  const handleSelectedOption = (e, option) => {
    ...
    if (option === "period") {
      ...
      tempAppraisals = tempAppraisals?.filter((appraisal) => {
        //to do (junaid needs to fix tje appraisalPeriodReference from the back)
          ...
          <div className="float-right d-flex col-lg-3">
            ...
            <div className="dropdown m-l-125">
              <button
                ...
                onClick={() => {
                  window.open(
                    `${performanceManagementAppraisalUrl}/DownloadReportByPeriodReference?appraisalReference=${periodReference ? periodReference : ""}`,
                    "_blank"
                  );
                }}
              >
